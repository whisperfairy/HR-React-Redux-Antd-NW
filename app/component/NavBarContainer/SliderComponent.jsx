...
class SliderComponent extends PureComponent {
    ...
    constructor(props) {
        super(props);
        console.log('SliderComponent ' + 'constructor' + arguments);
    }

    componentWillMount() {
        console.log('SliderComponent ' + ' componentWillMount' + arguments);
    }

    componentDidMount() {
        console.log('SliderComponent ' + ' componentDidMount' + arguments);
    }

    componentWillReceiveProps() {
        console.log('SliderComponent' + ' componentWillReceiveProps' + arguments);
    }

    shouldComponentUpdate() {
        console.log('SliderComponent ' + ' shouldComponentUpdate' + arguments);
        return true;
    }

    componentWillUpdate() {
        console.log('SliderComponent' + ' componentWillUpdate' + arguments);
    }

    componentDidUpdate() {
        console.log('SliderComponent' + ' componentDidUpdate' + arguments);
    }

    componentWillUnmount() {
        console.log('SliderComponent' + ' componentWillUnmount' + arguments);
    }
