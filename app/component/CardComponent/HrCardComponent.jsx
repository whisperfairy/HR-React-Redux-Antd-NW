...
import './_cards.scss'
class HrCardComponent extends PureComponent {
    static displayName = 'HrCardComponent';

    constructor(props) {
        super(props);
        console.log('HrCardComponent ' + 'constructor' + arguments);
    }

    componentWillMount() {
        console.log('HrCardComponent ' + ' componentWillMount' + arguments);
    }

    componentDidMount() {
        console.log('HrCardComponent ' + ' componentDidMount' + arguments);
    }

    componentWillReceiveProps() {
        console.log('HrCardComponent' + ' componentWillReceiveProps' + arguments);
    }

    shouldComponentUpdate() {
        console.log('HrCardComponent ' + ' shouldComponentUpdate' + arguments);
        return true;
    }

    componentWillUpdate() {
        console.log('HrCardComponent' + ' componentWillUpdate' + arguments);
    }

    componentDidUpdate() {
        console.log('HrCardComponent' + ' componentDidUpdate' + arguments);
    }

    componentWillUnmount() {
        console.log('HrCardComponent' + ' componentWillUnmount' + arguments);
    }

    render() {
        console.log('HrCardComponent' + 'rendering');
        return (
